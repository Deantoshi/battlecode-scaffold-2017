// /home/ddean/.config/opencode/plugin/ralph-wiggum.ts
...
// /home/ddean/.config/opencode/command/ralph-loop.md
// ---
...
// /home/ddean/.config/opencode/command/cancel-ralph.md
// ---
// description: Cancel an active Ralph Wiggum loop
// agent: build
// ---

// Use the `cancel_ralph` tool to stop the current Ralph loop.

// Report the result to the user, including which iteration it was stopped at.

// /home/ddean/.config/opencode/command/ralph-status.md
// ---
// description: Check the status of an active Ralph Wiggum loop
// agent: build
// ---
