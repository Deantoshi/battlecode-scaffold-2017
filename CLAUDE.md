This is the 2017 version of MITs Battlecode Scaffold Repo. You are on a Ubuntu WSL instance. The game uses Java 8. You are in VScode.
...
```bash
./gradlew run -PteamA=claudebot -PteamB=examplefuncsplayer -Pmaps=shrine
```
