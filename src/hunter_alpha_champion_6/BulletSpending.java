package hunter_alpha_champion_6;
import battlecode.common.*;

/**
 * Swarm Gardener - Centralized Bullet Spending (v8 mutation)
 *
 * Phase 1 (Rounds 1-200): Build economy foundation - hire gardeners, plant trees.
 * Phase 2 (Round 200+): HIGH gardener hire rate (25%) for parallel build queues.
 *   More gardeners = faster unit production + denser tree farms for sustained income.
 *   Unit priority: soldiers (40%) and scouts (20%). Zero tank production.
