        ...
        while (true) {
            ...
            try {
                ...
                if (robots.length > 0) {
                    ...
                    // Prefer triad shot for superior firepower; fall back to single
                ...
                // Converge toward archon broadcast location for grouping
                int xPos = rc.readBroadcast(0);
                int yPos = rc.readBroadcast(1);
                MapLocation archonLoc = new MapLocation(xPos, yPos);
                Direction towardArchon = myLocation.directionTo(archonLoc);
                tryMove(towardArchon);
