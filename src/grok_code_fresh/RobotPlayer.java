        ...
        while (true) {
            ...
            try {
                ...
                if (robots.length > 0) {
                    ...
                    // Move towards the enemy to swarm
                    Direction toEnemy = myLocation.directionTo(target.location);
                    if (rc.canMove(toEnemy)) {
                        rc.move(toEnemy);
                    } else {
                        // If can't move directly, try to move in a similar direction
                        tryMove(toEnemy);
                    }

                    // Fire triad shot at range if possible, otherwise single
                    ...
                    // No enemies in sight, move randomly to explore
                    tryMove(randomDirection());
                }
