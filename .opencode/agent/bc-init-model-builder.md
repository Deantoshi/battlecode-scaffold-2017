...
The bot folder name is specified in the Arguments section. Parse this to get the name for your new bot. If you only receive words like minimax_2_1 in the agent call, then minimax_2_1 is the name of the bot.
- **Example**: If the Arguments section is `my_awesome_bot`, create `src/my_awesome_bot/`
