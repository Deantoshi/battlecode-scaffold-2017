...
You orchestrate these specialized agents via direct agent invocations:
...
**How to invoke:** Use `@bc-runner --teamA=bot1 --teamB=bot2`.
...
Invoke bc-general:
  @bc-general --bot={BOT_NAME} --opponent={OPPONENT}
Provide it:
...
2. **Delegate via agents** - Use `/bc-xxx ...` (or `@bc-xxx ...`) for specialized work
